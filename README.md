...
If using the library in the __standard way__, compile your project with flags: `$(pkgconf --cflags genc)` and link with flags: `$(pkgconf --libs genc)`. For this to work, make sure that pkg-config searches in the directory of the .pc file generated in the installation process.
